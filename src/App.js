  ...
  return (
    <>
      ...
      <div className="container row py-5 align-items-center mx-auto">
        ...
        Terry tiene un don para la puntuacion del baloncesto lo que explica la creación de su movimiento de alimentacion Dunk." />
        <Card 
          img={kyo}
      ...
      <Footer description="&copy; Galería de imágenes de personajes correspondientes a distintas franquicias." />
    </>
  );
}
